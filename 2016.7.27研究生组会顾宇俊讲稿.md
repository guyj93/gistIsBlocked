...
* 难点：平衡特征的抽象程度 与 具体程度，平衡对干扰的鲁棒 与 对复杂特征的检出。
...
* CVPR15的一篇文章的升级版
* 数据集包括：建筑物、鞋子、汽车、人物
* ![鞋子](http://i4.piimg.com/567571/beac8c860bac47af.png)
* 研究方向与本课题非常相似
* 推崇使用机器自动习得的无语义属性
...
* 数据集包括衣物、动物
* ![衣物](http://i1.piimg.com/567571/67cc3a53d5322378.png)
* 预测的属性是有语义的
* 预测的属性是二元的，多元的属性也应化为二元属性
* ![Multi-taskCNNModel](http://i4.piimg.com/567571/3c44335b96dd190f.png)
...
* 与第二篇是同课题组作品
* 数据集为女式连衣裙
* ![连衣裙](http://i4.piimg.com/567571/8933e5dd4dc4cfbb.png)
* 使用了有语义和无语义两种属性
* 有语义属性即使用第二篇文章的模型来预测
