...
* CVPR15的一篇文章的升级版
* 数据集包括：建筑物、鞋子、汽车、人物
* ![鞋子](https://raw.githubusercontent.com/guyj93/gistIsBlocked/master/ReportOnDiscussion2016.7.27/shoes.PNG)
* 研究方向与本课题非常相似
* 推崇使用机器自动习得的无语义属性
...
* 数据集包括衣物、动物
* ![衣物](https://raw.githubusercontent.com/guyj93/gistIsBlocked/master/ReportOnDiscussion2016.7.27/clothing.PNG)
* 预测的属性是有语义的
...
* 与第二篇是同课题组作品
* 数据集为女式连衣裙
* ![连衣裙](https://raw.githubusercontent.com/guyj93/gistIsBlocked/master/ReportOnDiscussion2016.7.27/dress.PNG)
* 使用了有语义和无语义两种属性
* 有语义属性即使用第二篇文章的模型来预测
